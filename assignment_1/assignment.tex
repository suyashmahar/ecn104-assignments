...
\insertProblem {
  Write a module that multiplies a number by 3 using cascaded shift operations.
  
  Write a Verilog module which does something. Use \textsc{testbench{\ano}.{\theproblemNumber}.v} to verify output. (\textit{Hint: Assume the input is such that output doesn't overflows.})
}
...
\begin{itemize}
  ...
  \item Verilog HDL by Samir Palnitkar
